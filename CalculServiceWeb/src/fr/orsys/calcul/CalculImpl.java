...
public class CalculImpl implements CalculContrat {
	...
	public double calculer(Operateurs op, double operande1, double operande2) {
		...
		System.out.println("Web Service Operateur "+ op.name());
		System.out.println("Web Service Operande 1 "+ operande1);
		System.out.println("Web Service Operande 2 "+ operande2);
